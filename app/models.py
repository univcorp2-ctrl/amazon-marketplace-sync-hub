...
class BulkListingRequest(BaseModel):
    ...
    markup_percent: float | None = Field(default=None, ge=0, le=300)
    fixed_profit: int | None = Field(default=None, ge=0, le=1000000)
    minimum_margin: int | None = Field(default=None, ge=0, le=1000000)
    rights_confirmed: bool = False
    execute: bool = False
